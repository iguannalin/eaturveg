...
class App extends Component {
    ...
    getVeggies() {
        ...
        data.forEach(function (item) {
            // console.log(item);
            if (item.months[m]) {
                veggies.push(<a href={item.link} key={item.name}><p className="veggie">{item.name}</p></a>);
            }
        });
    ...
    scrollContentIntoView() {
        document.getElementById('veggies-list').scrollIntoView({behavior: "smooth"})
    }
        ...
        return (
            <div className="App">
                <header className="App-header">
                    ...
                    <span className="dots"><button
                        onClick={this.scrollContentIntoView}>...</button></span>
                </header>
                <div className="App-body" id="veggies-list">
